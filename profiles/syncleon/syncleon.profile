 ...
 * Implements hook_form_FORM_ID_alter().
 */
function syncleon_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['#submit'][] = 'syncleon_install_configure_form_submit';
}
 ...
 */
function syncleon_install_configure_form_submit($form, &$form_state) {
 ...
 */
function syncleon_menu_alter(&$menu) {
