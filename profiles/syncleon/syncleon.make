...
projects[content_management][type] = module
projects[content_management][download][type] = git
projects[content_management][download][url] = https://github.com/maerts/content_management.git
project[content_management][download][branch] = master
...
;projects[syncleon_suggestion_profiles][type] = module
;projects[syncleon_suggestion_profiles][download][type] = git
;projects[syncleon_suggestion_profiles][download][url] = https://github.com/maerts/syncleon_suggestion_profiles.git
;project[syncleon_suggestion_profiles][download][branch] = master
...
projects[views_languages_field][download][url] = https://github.com/maerts/views_languages_field.git
project[views_languages_field][download][branch] = master

projects[views_operations_field][type] = module
projects[views_operations_field][download][type] = git
projects[views_operations_field][download][url] = https://github.com/maerts/views_operations_field.git
project[views_operations_field][download][branch] = master
...
projects[rubik_left][type] = theme
projects[rubik_left][download][type] = git
projects[rubik_left][download][url] = https://github.com/maerts/rubik_left.git
project[rubik_left][download][branch] = master
